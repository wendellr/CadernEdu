const principles = [
  { name: 'Integração com legado', color: '#1B7B3F' },
  { name: 'Importação CSV/XLSX', color: '#0891B2' },
  { name: 'Piloto por escola', color: '#FB7185' },
  { name: 'LGPD-Kids desde o desenho', color: '#A78BFA' },
  { name: 'Evolução por módulos', color: '#FBBF24' },
]
